  ...
  return (
    <footer className="w-full bg-[#010E13] border-t border-white/5 py-16 px-4 md:px-8 relative z-10">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start gap-12 lg:gap-16">
        ...
        {/* Right Side: Connect */}
        <div className="flex flex-col items-center lg:items-end text-center lg:text-right flex-1 pt-4 relative z-10">
          <h3 className="font-display text-xl lg:text-2xl text-white tracking-widest mb-8 uppercase bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
            Get in Touch
          </h3>

          <div className="flex flex-col w-full max-w-[320px] gap-3.5 mb-10">
            <a href="tel:+94772086681" className="w-full px-6 py-3 rounded-full bg-white/[0.02] border border-white/10 hover:border-[#00E5FF]/40 hover:bg-[#00E5FF]/5 hover:shadow-[0_0_25px_rgba(0,229,255,0.15)] transition-all duration-300 flex items-center justify-between group backdrop-blur-md">
            ...
            <a href="tel:+94715435636" className="w-full px-6 py-3 rounded-full bg-white/[0.02] border border-white/10 hover:border-[#00E5FF]/40 hover:bg-[#00E5FF]/5 hover:shadow-[0_0_25px_rgba(0,229,255,0.15)] transition-all duration-300 flex items-center justify-between group backdrop-blur-md">
              <span className="text-gray-400 font-body text-sm group-hover:text-white transition-colors">Lawindi</span>
              <span className="text-white font-mono text-sm group-hover:text-[#00E5FF] transition-colors">+94 71 543 5636</span>
            </a>
            <a href="tel:+94724170019" className="w-full px-6 py-3 rounded-full bg-white/[0.02] border border-white/10 hover:border-[#00E5FF]/40 hover:bg-[#00E5FF]/5 hover:shadow-[0_0_25px_rgba(0,229,255,0.15)] transition-all duration-300 flex items-center justify-between group backdrop-blur-md">
          ...
          <div className="flex justify-center lg:justify-between gap-4 w-full max-w-[320px]">
            <a
              href="https://www.facebook.com/share/1Eq5BVbYQQ/?mibextid=wwXIfr"
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex justify-center p-3.5 rounded-full bg-white/[0.02] border border-white/10 hover:bg-[#00E5FF]/10 hover:border-[#00E5FF]/40 hover:shadow-[0_0_20px_rgba(0,229,255,0.2)] transition-all duration-300 text-gray-400 hover:text-white group backdrop-blur-sm"
            >
